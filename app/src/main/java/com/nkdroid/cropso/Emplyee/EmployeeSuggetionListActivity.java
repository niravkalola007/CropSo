...
public class EmployeeSuggetionListActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        projectList.add("e");
        projectList.add("f");
        projectListAdapter = new ProjectListAdapter(EmployeeSuggetionListActivity.this, projectList);
...
//                holder.img_delete= (ImageView) convertView.findViewById(R.id.img_delete);
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(EmployeeSuggetionListActivity.this,EmployeeTaskDetailActivity.class);
