...
public class EmployeeProjectListActivity extends ActionBarActivity {

    private ListView employee_project_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employee_project_list);
        employee_project_list= (ListView) findViewById(R.id.employee_project_list);
        setActionBar();
        ...
        projectList.add("e");
        projectList.add("f");
        projectListAdapter = new ProjectListAdapter(EmployeeProjectListActivity.this, projectList);
        employee_project_list.setAdapter(projectListAdapter);
    }
...
//                holder.img_delete= (ImageView) convertView.findViewById(R.id.img_delete);
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(EmployeeProjectListActivity.this,EmployeeProjectDetailActivity.class);
