...
public class PmResourceList extends ActionBarActivity {
    private Toolbar toolbar;
    private ListView employee_task_list;
    private ProjectListAdapter projectListAdapter;
    private ArrayList<String> projectList;
    private TextView txtAddNewResource;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pm_resource_list);
        employee_task_list= (ListView) findViewById(R.id.employee_task_list);
        txtAddNewResource= (TextView) findViewById(R.id.txtAddNewResource);
        txtAddNewResource.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(PmResourceList.this,PmAddNewResource.class);
        ...
        projectList.add("e");
        projectList.add("f");
        projectListAdapter = new ProjectListAdapter(PmResourceList.this, projectList);
...
//            ImageView img_edit,img_delete;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = mInflater.inflate(R.layout.item_resource_remove, parent, false);
