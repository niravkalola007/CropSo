...
public class PmProjectListActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        projectListAdapter = new ProjectListAdapter(PmProjectListActivity.this, projectList);
    ...
    private class ProjectListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.img_edit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(PmProjectListActivity.this,PmProjectEditableDetailActivity.class);
            ...
            holder.img_delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AlertDialog.Builder alert = new AlertDialog.Builder(PmProjectListActivity.this);
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(PmProjectListActivity.this,ProjectDashboardActivity.class);
                    startActivity(intent);
                }
            });
