...
public class PmAddNewResource extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pm_add_new_resource);
        ...
        txtAddNewResource.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(PmAddNewResource.this,PmAddNewResource.class);
