...
public class PmTaskList extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pm_task_list);
        employee_task_list= (ListView) findViewById(R.id.employee_task_list);
        txtAddNewTask= (TextView) findViewById(R.id.txtAddNewTask);
        txtAddNewTask.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(PmTaskList.this,PmAddNewTask.class);
        ...
        projectList.add("e");
        projectList.add("f");
        projectListAdapter = new ProjectListAdapter(PmTaskList.this, projectList);
...
//                holder.img_delete= (ImageView) convertView.findViewById(R.id.img_delete);
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(PmTaskList.this,PmTaskDetailActivity.class);
                    startActivity(intent);
                }
            });
