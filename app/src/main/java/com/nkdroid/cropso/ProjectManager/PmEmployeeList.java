...
public class PmEmployeeList extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pm_employee_list);
        ...
        txtAddNewEmployee.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(PmEmployeeList.this,PmAddNewEmployee.class);
        ...
        projectList.add("e");
        projectList.add("f");
        projectListAdapter = new ProjectListAdapter(PmEmployeeList.this, projectList);
