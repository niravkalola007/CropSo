        ...
        txt_add_client.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isEmptyField(etFirstName)){
                    Toast.makeText(AddNewClientActivity.this, "Please Enter First Name", Toast.LENGTH_LONG).show();
                } else if(isEmptyField(etLastName)){
                    Toast.makeText(AddNewClientActivity.this, "Please Enter Last Name", Toast.LENGTH_LONG).show();
                } else if(isEmptyField(etEmail)){
                    Toast.makeText(AddNewClientActivity.this, "Please Enter Email", Toast.LENGTH_LONG).show();
    ...
    private void addClient() {
        ...
        new AsyncTask<Void,Void,Void>(){
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog=new ProgressDialog(AddNewClientActivity.this);
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                try {
                    ...
                    if(responseCode.equalsIgnoreCase("success")){
                        Toast.makeText(AddNewClientActivity.this, "Client Added Successfully...", Toast.LENGTH_LONG).show();
                        finish();

                    } else {
                        Toast.makeText(AddNewClientActivity.this, "Error, Please Try again...", Toast.LENGTH_LONG).show();
                    }
                } catch (Exception e){
                    e.printStackTrace();
                }
