    ...
    private void deleteUser(final String id){
        ...
        new AsyncTask<Void,Void,Void>(){
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog=new ProgressDialog(AdminProjectListActivity.this);
                progressDialog.setMessage("Removing Project Manager...");
                progressDialog.show();
            }
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                try {
                    ...
                    if(responseCode.equalsIgnoreCase("success")){
                        ...
                        Toast.makeText(AdminProjectListActivity.this, "Error, Please Try again...", Toast.LENGTH_LONG).show();
                    }
                } catch (Exception e){
                    e.printStackTrace();
                }
    ...
    private void getUsers() {
        ...
        new AsyncTask<Void,Void,Void>(){
            ...
            protected void onPreExecute() {
                ...
                progressDialog.setMessage("Fetching project managers list...");
                progressDialog.show();
            }
